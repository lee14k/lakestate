  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="py-8">
          <HomeThree header="Social Skills & Life Training" bodyText="We provide opportunities for individuals to develop essential life skills, such as time management, interpersonal communication, and self-advocacy, to enhance their overall independence and well-being." photoURL="parallaxpic.jpg" reverse={false}
                     color="#ffa726" />
        </div>
        <div className="py-8">
          <HomeThree header="Assistive Technology & Accommodations" bodyText="We provide access to assistive devices, adaptive technologies, and reasonable accommodations in the workplace to ensure individuals can perform their job duties effectively and comfortably." photoURL="donate.jpg" reverse={true}
                     color="#1c468a" />
        </div>
