...
const WaveOther = ({ imageUrl, header}) => {
  return (
    <div className="w-full relative">
      ...
      <div className="absolute top-64 left-1/2 transform -translate-x-1/2 z-10 bg-white bg-opacity-50 rounded-2xl text-center ">
  <h1 className="mb-4 serviceheadline  ">{header}</h1> 
      </div>
    </div>
  );
};
