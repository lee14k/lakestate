    ...
    <div className="home-section-1 grid grid-cols-7 h-full">
      ...
      <div className="container col-span-3 flex-grow">
        <div className="flex flex-col justify-center items-center">
          ...
          <button className="rounded-md bg-orange-500 px-10 py-6 text-xl font-semibold text-white shadow-sm hover:bg-lakestate-blue focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lakestate-blue">Learn More</button>
        </div>
