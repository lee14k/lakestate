      ...
      >
        <div className="gradient-overlay flex flex-col justify-center items-center">
          <div className="flex flex-col justify-center items-center mt-4">
            <h1 className="text-white text-xl mb-6">Interested in our vocational training?</h1>
            <Link href="/VocationalTraining">
 <button className="rounded-md bg-orange-400 px-6 py-2 text-l font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">              Learn More
            </button>
            </Link>
          </div>
        </div>
